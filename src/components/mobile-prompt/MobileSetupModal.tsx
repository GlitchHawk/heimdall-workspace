  ...
  const steps = [
    {
      ...
      body: 'Install Tailscale on the machine running Heimdall Workspace, then sign in.',
    ...
    },
    {
      ...
      body: 'Heimdall Workspace can talk to any OpenAI-compatible backend on mobile too. Make sure both the workspace and backend stay reachable over Tailscale or your local network.',
    ...
    {
      title: 'Open Heimdall Workspace on your phone',
      body:
