...
export const tourSteps: Array<Step> = [
  // Step 1: Welcome
  {
    target: 'body',
    placement: 'center',
    title: 'Welcome to Heimdall Workspace! ⚕',
    content: (
      <div
        style={{
          display: 'flex',
  ...
  // Step 8: Terminal
  {
    ...
    content:
      'Built-in terminal for quick commands. Execute shell commands without leaving Heimdall Workspace.',
  },
  ...
  // Step 10: Settings
  {
    ...
    content:
      'Configure providers, themes, accent colors, and more. Make Heimdall Workspace yours.',
  },
  // Step 11: Finish
  {
    target: 'body',
    ...
    content:
      'Start chatting with your AI, explore the tools, and customize Heimdall Workspace to fit your workflow. Need help? Press ? to see all keyboard shortcuts.',
  },
]
