        ...
        >
          {step === 'welcome' && (
            <div className="space-y-4 text-center">
              ...
              />
              <h2 className="text-xl font-bold">Welcome to Heimdall Workspace</h2>
          ...
          {step === 'connect' && (
            <div className="space-y-4 text-center">
              ...
              <p className="text-sm" style={mutedStyle}>
                Start by verifying that Heimdall Workspace can reach your
            ...
            <div className="space-y-4">
              ...
              <p className="text-center text-xs" style={mutedStyle}>
                {canEditConfig
                  ...
                  : 'This backend manages provider settings outside Heimdall Workspace. Confirm the model you expect to use, then test chat.'}
              </p>
